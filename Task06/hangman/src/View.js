...
export function informationOutput() {
    if (field_name.value === "") {
        ...
        text_info.innerHTML = "Браузерная Игра 'Виселица' (hangman). Компьютер загадывает слово из шести букв на русском языке "+ 
        "(список возможных слов заранее сгенерирован) и рисует на странице отдельные пустые клетки для каждой буквы. "+ 
       "Игрок пытается угадать буквы(вводя их по одной в текстовое поле), а затем и все слово "+ 
